...
public class traditionalchineseTextFormatingActivity extends Activity {
	...
	public void PrintText(View view)
	{
		...
		PrinterFunctions.PrintTextTraditionalChinese(this, portName, portSettings, underline, invertColor, emphasized, upperline, upsideDown, heightExpansion, widthExpansion, leftMargin, alignment, textToPrint);
	}
