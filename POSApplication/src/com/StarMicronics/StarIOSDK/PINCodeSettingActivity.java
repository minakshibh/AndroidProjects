		...
		listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				case 0: //PINCode numeric
				{
					...
					.setTitle(getString(R.string.change_pin_code))
					.setSingleChoiceItems(changePinCodeSettings, selectedIndex, new DialogInterface.OnClickListener() {
				...
				case 1: //�p��PIN�R�[�h����
				{
					...
					new AlertDialog.Builder(view.getContext())
					.setTitle(getString(R.string.allow_alphabet_pin_code))
					.setSingleChoiceItems(allowAlphabetPinCodeSettings, selectedIndex, new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog, int which) {
							selectedIndex = which;
						}
					})
		...
		.setPositiveButton("OK", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				if (editText.getText().length() < 4) {
					...
					.setMessage(getString(R.string.pincode_character_number_error))
