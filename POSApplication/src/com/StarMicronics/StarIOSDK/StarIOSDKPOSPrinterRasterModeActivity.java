...
public class StarIOSDKPOSPrinterRasterModeActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("tag", "enter in Raster Mode Actiivty");
        ...
        portNameField = (EditText)findViewById(R.id.editText_PortName);
    ...
    public void savePortName(String portName){
    	prefEditor = pref.edit();
    	prefEditor.putString("portName", portName);
    	prefEditor.commit();
    }
...
//    	EditText portNameField = (EditText)findViewById(R.id.editText_PortName);
    	...
    	savePortName(portNameField.getText().toString());
...
//    	EditText portNameField = (EditText)findViewById(R.id.editText_PortName);
        ...
        startActivityFromChild(this, myIntent, 0);
        Log.i("tag", "select sample receiprt function");
