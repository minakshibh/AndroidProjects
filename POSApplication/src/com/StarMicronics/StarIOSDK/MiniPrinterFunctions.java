...
public class MiniPrinterFunctions 
{
	 ...
	 * @param maxWidth - The maximum width of the image to print.  This is usually the page width of the printer.  If the image exceeds the maximum width then the image is scaled down.  The ratio is maintained. 
	 */
	public static void PrintBitmapImage(Context context, String portName, String portSettings,ArrayList<String> source, int maxWidth, boolean compressionEnable, boolean pageModeEnable)
	{
...
//            list.addAll(Arrays.asList(new Byte[]{0x1b, 0x66, 0x00}));                 //Stored Logo Printing  <ESC> f n       (n = Store Logo # = 0 or 1 or 2 etc.)
    ...
    public static void PrintSampleReceiptJp(Context context, String portName, String portSettings, String strPrintArea)
    {
		if (strPrintArea.equals("2inch (58mm)")) {
			...
			list.addAll(Arrays.asList(new Byte[]{0x1c, 0x43, 0x01}));                 // æ¼¢å­—ãƒ¢ãƒ¼ãƒ‰è¨­å®š
			list.addAll(Arrays.asList(new Byte[]{0x1b, 0x61, 0x31}));                 // ä¸­å¤®æ�ƒã�ˆè¨­å®š
			
			list.addAll(Arrays.asList(new Byte[]{0x1b, 0x21, 0x22}));                 // æ–‡å­—ç¸¦æ‹¡å¤§è¨­å®š
			list.addAll(Arrays.asList(new Byte[]{0x1b, 0x45, 0x31}));                 // å¼·èª¿å�°å­—è¨­å®š
			...
			list.addAll(Arrays.asList(new Byte[]{0x1b, 0x21, 0x11}));                 // æ–‡å­—ç¸¦æ‹¡å¤§è¨­å®š
			...
			list.addAll(Arrays.asList(new Byte[]{0x1b, 0x21, 0x00}));                 // æ–‡å­—ç¸¦æ‹¡å¤§è§£é™¤
			list.addAll(Arrays.asList(new Byte[]{0x1b, 0x45, 0x00}));                 // å¼·èª¿å�°å­—è§£é™¤
			...
			list.addAll(Arrays.asList(new Byte[]{0x1b, 0x61, 0x30}));                 // å·¦æ�ƒã�ˆè¨­å®š
			...
			list.addAll(Arrays.asList(new Byte[]{0x1b, 0x74, 0x01}));                 // æ–‡å­—ã‚³ãƒ¼ãƒ‰è¨­å®šï¼ˆï½¶ï¾€ï½¶ï¾…ï¼‰
			...
			NumberFormat exsub=NumberFormat.getNumberInstance();    //é€šè²¨è¡¨ç¤ºè¨­å®š
			
			tax=sub*5/100;
			NumberFormat extax=NumberFormat.getNumberInstance();    //é€šè²¨è¡¨ç¤ºè¨­å®š
    ...
    public static void PrintSampleReceiptCHT(Context context, String portName, String portSettings, String strPrintArea)
    {
         if (strPrintArea.equals("3inch (78mm)")) {
			...
			list.addAll(Arrays.asList(new Byte[]{0x1c, 0x43, 0x01}));                    // æ¼¢å­—ãƒ¢ãƒ¼ãƒ‰è¨­å®š
			list.addAll(Arrays.asList(new Byte[]{0x1b, 0x61, 0x31}));                    // ä¸­å¤®æ�ƒã�ˆè¨­å®š		
			list.addAll(Arrays.asList(new Byte[]{0x1b, 0x21, 0x32}));                    // æ–‡å­—ç¸¦æ‹¡å¤§è¨­å®š
			list.addAll(Arrays.asList(new Byte[]{0x1b, 0x45, 0x31}));                    // å¼·èª¿å�°å­—è¨­å®š
			...
			list.addAll(Arrays.asList(new Byte[]{0x1b, 0x21, 0x33}));                    // æ–‡å­—ç¸¦æ‹¡å¤§è¨­å®š
			...
			//1D barcode example
			list.addAll(Arrays.asList(new Byte[]{0x1d, 0x77, 0x02}));                 //for 1D Code39 Barcode GS w n
			list.addAll(Arrays.asList(new Byte[]{0x1d, 0x68, 0x64}));                 //for 1D Code39 Barcode GS h n
			list.addAll(Arrays.asList(new Byte[]{0x1d, 0x48, 0x00}));                 //for 1D Code39 Barcode GS H n
			list.addAll(Arrays.asList(new Byte[]{0x1d, 0x6b, 0x45, 0x0b, 0x39, 0x39, 0x39, 0x39, 0x39, 0x39, 0x39, 0x37, 0x38, 0x39, 0x39}));           //for 1D Code39 Barcode
			...
			byte[] qrcodeByteBuffer = new byte[]{0x1d, 0x5a, 0x02, 0x1b, 0x5a,  //GS z n + ESC Z m a k nL nH d1..dk
                    0x00, 0x51, 0x06, 0x23, 0x00,
                    0x68, 0x74, 0x74, 0x70, 0x3a,
                    0x2f, 0x2f, 0x77, 0x77, 0x77,
                    0x2e, 0x73, 0x74, 0x61, 0x72,
                    0x2d, 0x6d, 0x2e, 0x6a, 0x70,
                    0x2f, 0x65, 0x6e, 0x67, 0x2f,
			...
			list.addAll(Arrays.asList(new Byte[]{0x1b, 0x61, 0x30}));                    // å·¦æ�ƒã�ˆè¨­å®š
			list.addAll(Arrays.asList(new Byte[]{0x1b, 0x61, 0x32}));                    // å�³æ�ƒã�ˆè¨­å®š
			...
			list.addAll(Arrays.asList(new Byte[]{0x1b, 0x61, 0x31}));                    // å·¦æ�ƒã�ˆè¨­å®š
