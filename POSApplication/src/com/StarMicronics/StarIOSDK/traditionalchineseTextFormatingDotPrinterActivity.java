...
public class traditionalchineseTextFormatingDotPrinterActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        SpinnerAdapter ad = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, new String[] {"Left", "Center", "Right"});
	...
	public void PrintText(View view)
	{
		...
		PrinterFunctions.PrintTextTraditionalChinesebyDotPrinter(this, portName, portSettings, underline, twoColor, emphasized, upperline, upsideDown, widthExpansion, leftMargin, alignment, textToPrint);
	}
	
	public void Help(View view)
	 {
		if (!checkClick.isClickEvent()) return;
		String helpString = "<UnderlineTitle>Character Expansion Settings</UnderlineTitle><br/><br/>\n" +
                			"Width Expansion<br/>\n" +
                			...
                			"More info in section 3.3.2. of the Impact Dot Matrix Manual.<br/><br/>\n" +
                			...
                			"More info in section 3.3.3 of the Impact Dot Matrix Manual<br/><br/>\n" +
                			...
                			"More info in section 3.3.6 of the Impact Dot Matrix Manual.<br/><br/>\n" +
