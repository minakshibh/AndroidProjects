...
public class ImageLoaderAlbum {
	...
	private Map<String, Bitmap> cache=Collections.synchronizedMap(
	    ...
	    public ImageLoaderAlbum(Context context){
...
//	    	
	    	...
	    	Album album=handler.getAlbumById(sid);
	    	
	    	byte image[]=album.getAlbumImage();
	    	 handler=new ZoomKaraokeDatabaseHandler(mcontext);
	    	 
	    	if(image==null)
	    	{
	    		byte[] imagebyte=null;
	    		 imagebyte=getDecodeUrl(album.getThumbnailUrl());
	    		album.setAlbumImage(imagebyte);
	    		
	    		
	    		handler.updateAlbumImage(album.getAlbumId(), album);
