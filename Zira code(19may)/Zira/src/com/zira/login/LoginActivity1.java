...
public class LoginActivity1 extends Activity implements 
ConnectionCallbacks, OnConnectionFailedListener,AsyncResponseForZira{
...
//	private Button btnLogin;
	...
	private String getUserVehicleProfile = "GetProfile";
	...
	Editor e;
	String fbFirstName="",fbLastName="",fbEmail="";
	String encoded="";
		...
		mAsyncRunner.request("me", new RequestListener() {
			...
			public void onComplete(String response, Object state) {
				...
				try {
					...
					//					String mobilePhone=profile.getString("mobile_phone");
					...
					new LoadProfileImageAndConvertingToBase64().execute(image_url);
	...
	class GetData extends AsyncTask<String, String, String>{
		...
		protected String doInBackground(String... str) {
			try{
				...
				String responseString = Util.getResponseFromUrl("Login", nameValuePairs, LoginActivity1.this);
		...
		protected void onPreExecute() {
			progress = ProgressDialog.show(LoginActivity1.this, "Zira 24/7", "Loading...");
		}
...
//	        progress.dismiss();
	        ...
	        if(user.getResult().equals("0")){
	        	SingleTon.getInstance().setUser(user);
	        		try{
		        		...
		        		AsyncTaskForZira mWebPageTask = new AsyncTaskForZira(LoginActivity1.this, getUserVehicleProfile,nameValuePair, true,"Please wait...");
		        		mWebPageTask.delegate = (AsyncResponseForZira) LoginActivity1.this;
	        	...
	        	progress.dismiss();
	        	Util.alertMessage(LoginActivity1.this, user.getMessage());
	        }
	        }catch(Exception e){
	        	e.printStackTrace();
	        	progress.dismiss();
	        	Util.alertMessage(LoginActivity1.this, "Something went wrong. Please try again later.");
	        }
	    }
	}
	...
	private View.OnClickListener listener = new View.OnClickListener() {
		...
		public void onClick(View v) {
			if(v == btnLogin){
				Util.hideKeyboard(LoginActivity1.this);
				if(txtPassword.getText().toString().trim().equals("") || txtEmail.getText().toString().trim().equals("")){
					...
					if(Util.isNetworkAvailable(LoginActivity1.this))
						new GetData().execute();
					else
					{
						Util.alertMessage(LoginActivity1.this, "Please check your internet connection");
					}
				}
			}else if(v == register){
				Intent intent = new Intent(LoginActivity1.this, ValidateEmailPhoneNumber.class);
				startActivity(intent);
			}else if(v == forgotPassword){
				Intent intent = new Intent(LoginActivity1.this, ForgotPassword.class);
				startActivity(intent);
	...
	private void getProfileInformation1() {
		try {
			if (Plus.PeopleApi.getCurrentPerson(mGoogleApiClient) != null) {
				...
				new LoadProfileImageAndConvertingToBase64().execute(personPhotoUrl);

				String personGooglePlusProfile = currentPerson.getUrl();
				Log.e(TAG, "Name: " + personName + ", plusProfile: "
						+ personGooglePlusProfile + ", email: " + email
						+ ", Image: " + personPhotoUrl);
				//				Toast.makeText(getApplicationContext(),"Email:"+email +"\n"+" Name:"+personName +" \n"+" PhotoUrl:"+personPhotoUrl , Toast.LENGTH_SHORT).show();
...
//			Toast.makeText(this, "Logout", Toast.LENGTH_SHORT).show();
	...
	//******************Class Converting Bitmap To base 64******************************//
	private class LoadProfileImageAndConvertingToBase64 extends AsyncTask<String, Void, Bitmap> {
		...
		protected void onPostExecute(Bitmap result) {
			...
			if(value.equals("fb"))
			{
				...
				AsyncTaskForZira mFetchStates = new AsyncTaskForZira(LoginActivity1.this, loginWith,nameValuePairs,true, "Please wait...");
				mFetchStates.delegate = (AsyncResponseForZira) LoginActivity1.this;
	...
	public void processFinish(String output, String methodName) {
		...
		if(methodName.equals(getUserVehicleProfile)){			
			mProfileInfoModel = ziraParser.profileInfo(output);
			SingleTon.getInstance().setProfileInfoModel(mProfileInfoModel);			
			//progress.dismiss();
			Intent intent = new Intent(LoginActivity1.this, VehicleSearchActivity.class);
        	startActivity(intent);
        	finish();
		} 
