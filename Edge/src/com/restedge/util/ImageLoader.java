...
//	    	
	    	...
	    	City city=handler.getCity(cid);
	    	
	    	byte image[]=city.getCityimage();
	    	 handler=new RestaurantDatabase(mcontext);
	    	 
	    	if(image==null)
	    	{
	    		byte[] imagebyte=null;
	    		 imagebyte=getDecodeUrl(city.getCityUrl());
	    		city.setCityimage(imagebyte);
	    		
	    		
	    		handler.updateCity(city.getCityId(), city);
