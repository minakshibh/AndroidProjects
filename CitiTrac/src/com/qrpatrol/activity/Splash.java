			...
			/*		mSharedPreferences=Splash.this.getSharedPreferences("MyPref", android.content.Context.MODE_PRIVATE);
					...
					if(str==null||str.equals("")){
						*/
						...
						Util.fetchIncidents(Splash.this, false);
		...
		System.err.println(output);
			...
			if(methodName.equals("officer-schedule")){
				...
				if (Util.isNetworkAvailable(Splash.this)){
					Util.fetchOrderList(Splash.this,officer.getOfficerId(), officer.getShiftId(),false );//officer.getOfficerId(), officer.getShiftId());
				}else{
					goToNextScreen();
				}
				...
				if (Util.isNetworkAvailable(Splash.this)){
					Util.fetchSchedule(Splash.this, officer.getOfficerId(), officer.getShiftId(), "all", false);
				}else{
					goToNextScreen();
				}
...
//					dbHandler.deleteLogs();
					...
					if(!patrolId.equals("0")){
						if (Util.isNetworkAvailable(Splash.this)){
							Util.fetchEvents(Splash.this, patrolId, false);
						}else{
							goToNextScreen();
						}
					}else{
